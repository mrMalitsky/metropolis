...
//           const currentPosition = this.target3D.position;
...
//           });
//
//           const targetCameraPosition = this.camera.object3D.translateOnAxis( new THREE.Vector3(0, 0, 1), this.distance ).position;
//
//           el.setAttribute('position', {
